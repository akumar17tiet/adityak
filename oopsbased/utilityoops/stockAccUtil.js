...
class stockAccount
{
    ...
    buy(content, userContent, obj1)
    {
        ...
        fs.writeFileSync('./JSONfiles/stockTransaction.json', outString);
        i++;
    ...
    write(content, userContent)
    {
        ...
        fs.writeFileSync('./JSONfiles/stockInput.json', outContent);

        /**
         * @description : User portfolio file stringified and written
         */
        var outUserContent = JSON.stringify(userContent, null, 2);
        fs.writeFileSync('./JSONfiles/userStockFile.json', outUserContent);
    }
