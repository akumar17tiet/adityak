        ...
        user.findOne({ email: body.email }, (err, res) => {
            if (!res) {
                ...
                var transporter = nodemailer.createTransport({
                    service: "Gmail",
                    auth: {
                        user: 'chatappadm@gmail.com',
                        pass: 'qwertychatapp'
                    }
                });
                var mailOptions = {
                    from: 'chatApp <chatappadm@gmail.com>',
                    to: res.email,
                    subject: 'Reset password',
                    text: 'Hello, You can reset your password using the link http://localhost:3000/reset/'+tokens+' which will expire in 15 minutes.'
                };
